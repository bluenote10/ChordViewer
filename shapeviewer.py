...
class MainFrame(wx.Frame):
    def __init__(self): # {{{
        ...
        # load chords
        self.shapes = [ [[(0,"-"),(1,"I"),(3,"D")],[(0,"P"),(1,"L"),(3,"M")],[(0,"A"),(2,"-"),(3,"I")],[(0,"D"),(2,"P"),(3,"L")],[(1,"M"),(3,"A")],[(0,"-"),(1,"I"),(3,"D")]],
                        [[(1,"D"),(3,"P"),(4,"L")],[(1,"M"),(3,"A")],[(0,"-"),(1,"I"),(3,"D")],[(0,"P"),(1,"L"),(3,"M")],[(1,"A"),(3,"-"),(4,"I")],[(1,"D"),(3,"P"),(4,"L")]],
                        [[(0,"P"),(1,"L"),(3,"M")],[(0,"A"),(2,"-"),(3,"I")],[(0,"D"),(2,"P"),(3,"L")],[(0,"M"),(2,"A")],[(0,"-"),(1,"I"),(3,"D")],[(0,"P"),(1,"L"),(3,"M")]],
                        [[(1,"M"),(3,"A")],[(0,"-"),(1,"I"),(3,"D")],[(0,"P"),(1,"L"),(3,"M")],[(0,"A"),(2,"-"),(3,"I")],[(1,"D"),(3,"P"),(4,"L")],[(1,"M"),(3,"A")]],
                        [[(1,"A"),(3,"-"),(4,"I")],[(1,"D"),(3,"P"),(4,"L")],[(1,"M"),(3,"A")],[(0,"-"),(1,"I"),(3,"D")],[(1,"P"),(2,"L"),(4,"M")],[(1,"A"),(3,"-"),(4,"I")]] ]
        self.curshape = 0
...
# }}}
    def OnPaint(self, evt): # {{{
        ...
        for s in range(6):
            for i in range(len(self.shapes[self.curshape][s])):
                offset = self.shapes[self.curshape][s][i][0]
                if self.curshape != 0 and self.curshape != 2: offset -= 1
                x = box[3 + offset]
                size = stringspace / 3.5
                print self.curshape, s
                gc.SetBrush(wx.Brush(colors[stringset[self.curshape][s] - 1]))
                gc.DrawEllipse(x - size, sy[5-s] - size, size*2, size*2)
                label = self.shapes[self.curshape][s][i][1]
...
# }}}
    ...
    def OnKey(self, evt): # {{{
        ...
        if keycode == 317: #down
            self.curshape += 1
            if self.curshape > 4: self.curshape = 0
            self.OnPaint(evt)
        elif keycode == 315: #up
            self.curshape -= 1
            if self.curshape < 0: self.curshape = 4
            self.OnPaint(evt)
    # }}}
